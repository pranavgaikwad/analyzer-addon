module github.com/pranavgaikwad/analyzer-addon

go 1.19

require (
	github.com/konveyor/analyzer-lsp v0.0.0-20230328212136-bb7767a5774a
...
replace github.com/konveyor/analyzer-lsp => /home/pranav/Projects/analyzer-lsp
